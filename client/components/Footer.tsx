    ...
    <footer className="w-full bg-white">
      ...
      <section className="relative w-full py-16 px-4 md:px-8 lg:px-16 xl:px-24">
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto text-center">
          <h2 className="text-white font-oswald text-4xl md:text-5xl font-semibold mb-4">
            READY TO EXPLORE THE WORLD?
          </h2>
          <p className="text-white font-poppins text-base font-medium mb-8">
            Let us help you create unforgettable memories with our special tours and destinations.
          </p>
          <button className="bg-tourism-primary text-white px-8 py-3 rounded font-poppins text-lg font-semibold hover:bg-tourism-primary/90 transition-colors">
            Book now
          </button>
        </div>
      </section>
      ...
      {/* Branches Section */}
      <div className="bg-tourism-primary py-6 px-4 md:px-8 lg:px-16 xl:px-24">
        <div className="max-w-[1440px] mx-auto text-center">
          <h3 className="text-white font-poppins text-base font-medium mb-2">
            Our Branches
          </h3>
          <div className="w-44 h-px bg-white mx-auto mb-4"></div>
          <p className="text-white font-poppins text-sm tracking-wider">
        ...
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <div className="w-7 h-7 bg-gray-400 rounded-full flex items-center justify-center hover:bg-tourism-primary transition-colors cursor-pointer">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-tourism-primary font-poppins text-base font-medium mb-6">
              Quick links
            </h4>
            <ul className="space-y-3">
              <li><Link to="/" className="text-gray-600 font-poppins text-sm hover:text-tourism-primary transition-colors">Home</Link></li>
              <li><Link to="/packages" className="text-gray-600 font-poppins text-sm hover:text-tourism-primary transition-colors">Packages</Link></li>
              <li><Link to="/about" className="text-gray-600 font-poppins text-sm hover:text-tourism-primary transition-colors">About us</Link></li>
              <li><Link to="/contact" className="text-gray-600 font-poppins text-sm hover:text-tourism-primary transition-colors">Contact us</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-600 font-poppins text-sm">+91 81484 32978</span>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-600 font-poppins text-sm">radanholidays@gmail.com</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-gray-300 py-8 px-4 md:px-8 lg:px-16 xl:px-24">
