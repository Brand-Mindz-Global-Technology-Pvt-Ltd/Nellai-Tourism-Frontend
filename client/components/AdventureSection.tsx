    ...
    <section className="w-full py-16 px-4 md:px-8 lg:px-16 xl:px-24">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="relative">
          <div className="flex gap-5 overflow-x-auto pb-8 scrollbar-hide" id="adventure-scroll">
            {adventures.map((adventure, index) => (
              <div key={index} className="relative group flex-shrink-0 w-[300px]">
                {/* Main Card */}
          ...
          <div className="flex justify-center mt-8">
            <div className="w-full max-w-4xl h-1 bg-gray-200 rounded-full">
