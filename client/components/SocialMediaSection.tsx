  ...
  return (
    <section className="w-full py-16 px-4 md:px-8 lg:px-16 xl:px-24">
      <div className="max-w-[1440px] mx-auto">
        <h2 className="text-black font-sen text-3xl md:text-4xl font-semibold uppercase mb-12">
          Social media pages
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="relative rounded-lg overflow-hidden shadow-lg bg-gray-700">
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm border-2 border-white cursor-pointer hover:bg-white/30 transition-colors">
          ...
          <div className="relative rounded-lg overflow-hidden shadow-lg">
            <div 
              className="w-full h-[500px] bg-cover bg-center bg-gradient-to-t from-black/20 to-transparent"
              style={{
                backgroundImage: "url('https://api.builder.io/api/v1/image/assets/TEMP/24e3a3abbf59534f7c72d504600eb2972bac0807?width=974')"
              }}
            />
