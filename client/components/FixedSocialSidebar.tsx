        ...
        <div className="flex flex-col gap-2">
          {socialLinks.map(({ href, label, icon }, index) => (
            <a
              ...
              aria-label={label}
              className="w-12 h-12 bg-tourism-primary rounded-lg flex items-center justify-center text-white hover:bg-tourism-primary/80 transition-all duration-300 hover:scale-105"
              title={label}
            >
              {icon}
            </a>
